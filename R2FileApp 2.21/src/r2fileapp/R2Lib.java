...
public class R2Lib {
	...
	//
    // //////////////////////////////////////////////////////
	public String RtoosFinal(String serviceid, String serviceurl, String serviceparam, String servicetype, JSONObject jsonrtoos) throws IOException
		{
		  try 
		  {
			  String rootid = jsonrtoos.getString("root_service");
	...
	// without passed in serviceid
	public String RtoosFinal(String serviceurl, String serviceparam, String servicetype, JSONObject jsonrtoos) throws IOException
	{
		  String serviceid = RtoosGetID();
		  try 
		  {
			  return RtoosFinal(serviceid, serviceurl, serviceparam, servicetype, jsonrtoos);
		  }
		  catch (IOException  e) 
		  {
			  /*report an error*/ 
	...
	{
	      //System.out.println("RtoosUpdate Starting: ");
		  try 
		  {
			  String rootid = jsonrtoos.getString("root_service");
			  ...
			  newrequest.put("rtoos_msg", newservice);
			  newrequest.put("type", "Indvidual");
		      //System.out.println("RtoosUpdate Sending: ");
			  String resp = SendEvent(newrequest.toString());	  
		     // System.out.println("RtoosUpdate Ending: ");
			  return resp.toString();
