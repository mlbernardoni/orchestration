		...
		String serviceparam = null;
		  ...
		  try 
		  {
			  ...
			  if (sttype.equals("Event") )
			  {
			      ...
			      //
			      // //////////////////////////////////////////////////////
				  r2lib.RtoosFinal("http://localhost:8080/R2FileApp/Finally.html", "COMPLETE", "Register", jsonrtoos);
				  //
				  ...
				  if (Authenticate.equals("Batch"))
				  {
					  ...
					  // Batch
				      // //////////////////////////////////////////////////////
					  r2lib.RtoosSubsequent("http://localhost:8080/R2FileApp/BatchController.html", serviceparam, "Register", jsonrtoos.getString("service"), jsonrtoos);
				  }
				  else if (Authenticate.equals("Transaction") )
				  {
					  ...
					  // Transaction
				      // //////////////////////////////////////////////////////
					  r2lib.RtoosSubsequent("http://localhost:8080/R2FileApp/TransactionController2.html", serviceparam, "Register", jsonrtoos.getString("service"), jsonrtoos);
				  }
				  session.close();
			      cluster.close();
