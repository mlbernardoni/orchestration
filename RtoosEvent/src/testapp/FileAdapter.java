...
public class FileAdapter extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String resp = null;
		  ...
		  try 
		  {
			  ...
			  else if (sttype.equals("ImportFile") )
			  {
				  				  
				  resp = rtooslib.RtoosRoot("http://localhost:8080/RtoosEvent/ImportFile.html", jsonrtoos.toString() );
			  }
